...
public class CloudletSchedulerDynamicWorkload extends CloudletSchedulerTimeShared {
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			if (rcl.getRemainingCloudletLength() == 0) { // finished: remove from the list
				...
				System.out.print("estimatedFinishTime: "+estimatedFinishTime);
				System.out.println("\tcurrentTime: "+currentTime);
				if (estimatedFinishTime - currentTime < CloudSim.getMinTimeBetweenEvents()) {		//ct=300	,eft=350	, gmt=25
	...
	public Map<String, Double> getUnderAllocatedMips() {
		System.out.println("underAllocatedMips:*****"+underAllocatedMips);
...
//		System.out.println("cachePreviousTime:"+cachePreviousTime);
