...
import org.cloudbus.cloudsim.container.hostSelectionPolicies.HostSelectionPolicyLeastFull;
import org.cloudbus.cloudsim.container.hostSelectionPolicies.HostSelectionPolicyMinimumCorrelation;
import org.cloudbus.cloudsim.container.hostSelectionPolicies.HostSelectionPolicyMostFull;
import org.cloudbus.cloudsim.container.hostSelectionPolicies.HostSelectionPolicyRandomSelection;
 ...
 */
public class ContainerCloudSimExampleRR {
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          HostSelectionPolicy hostSelectionPolicy = new HostSelectionPolicyFirstFit();
            ...
            //HostSelectionPolicy hostSelectionPolicy = new HostSelectionPolicyLeastFull();
            
            //HostSelectionPolicy hostSelectionPolicy = new HostSelectionPolicyMinimumCorrelation();
            
          //HostSelectionPolicy hostSelectionPolicy = new HostSelectionPolicyMostFull();
            
         //  HostSelectionPolicy hostSelectionPolicy = new HostSelectionPolicyRandomSelection();
            /**
    ...
    public static ContainerDatacenter createDatacenter(String name, Class<? extends ContainerDatacenter> datacenterClass,
        ...
        ContainerDatacenterCharacteristics characteristics = new
                ...
                costPerBw);
        ContainerVmAllocationPolicyRR vmPolicy=new ContainerVmAllocationPolicyRR(hostList);
        ContainerDatacenter datacenter = new PowerContainerDatacenterCM(name, characteristics, vmPolicy,
    ...
    public static List<ContainerCloudlet> createContainerCloudletList(int brokerId, int numberOfCloudlets)
            throws FileNotFoundException {
        String inputFolderName = ContainerCloudSimExampleRR.class.getClassLoader().getResource("workload/planetlab").getPath();
